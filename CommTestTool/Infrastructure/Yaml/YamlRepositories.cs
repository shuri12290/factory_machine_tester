...
public class YamlDeviceRepository(IAppPaths paths) : IDeviceRepository
{
    ...
    private static StepYaml ToYaml(StepModel m) => new()
    {
        ...
        ConnectionId = m.ConnectionId, NodeId = m.NodeId, MethodId = m.MethodId, Address = m.Address,
    ...
    private static StepModel ToModel(StepYaml y) => new(
        ...
        y.NodeId, y.MethodId, y.Address, y.TimeoutMs, y.TimeoutMsParam, y.DurationMs, y.DurationMsParam, y.IntervalMsParam, y.ReadTimeoutParam, y.TimeoutParam, y.Parameter, y.Payload,
